# graphql-go [![Sourcegraph](https://sourcegraph.com/github.com/dunstack/graphql-go/-/badge.svg)](https://sourcegraph.com/github.com/dunstack/graphql-go?badge) [![Build Status](https://graph-gophers.semaphoreci.com/badges/graphql-go/branches/master.svg?style=shields)](https://graph-gophers.semaphoreci.com/projects/graphql-go) [![Go Report](https://goreportcard.com/badge/github.com/dunstack/graphql-go)](https://goreportcard.com/report/github.com/dunstack/graphql-go) [![GoDoc](https://godoc.org/github.com/dunstack/graphql-go?status.svg)](https://godoc.org/github.com/dunstack/graphql-go)
...
## (Some) Documentation [![GoDoc](https://godoc.org/github.com/dunstack/graphql-go?status.svg)](https://godoc.org/github.com/dunstack/graphql-go)
...
```
For more realistic usecases check our [examples section](https://github.com/dunstack/graphql-go/wiki/Examples).
...
> **NOTE**: This feature is not in the stable release yet. In order to use it you need to run `go get github.com/dunstack/graphql-go@master` and in your `go.mod` file you will have something like:
>  ```
...
import (
	...
	otelgraphql "github.com/dunstack/graphql-go/trace/otel"
...
### [Examples](https://github.com/dunstack/graphql-go/wiki/Examples)
